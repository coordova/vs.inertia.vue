...
CREATE TABLE IF NOT EXISTS "surveys" ("id" integer primary key autoincrement not null, "category_id" integer not null, "title" varchar not null, "slug" varchar not null, "description" text, "image" varchar, "type" integer not null default '0', "status" tinyint(1) not null default '0', "reverse" tinyint(1) not null default '0', "date_start" date not null, "date_end" date not null, "selection_strategy" varchar not null default 'cooldown', "max_votes_per_user" integer not null default '0', "allow_ties" tinyint(1) not null default '0', "tie_weight" numeric not null default '0.5', "is_featured" tinyint(1) not null default '0', "sort_order" integer not null default '0', "counter" integer not null default '0', "meta_title" varchar, "meta_description" varchar, "created_at" datetime, "updated_at" datetime, "deleted_at" datetime, foreign key("category_id") references "categories"("id") on delete cascade);
