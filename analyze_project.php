...
class FilesystemStructureAnalyzer
{
    ...
    private function analyzeFileStructure(): void
    {
        ...
        $validFiles = $this->countValidFiles();
        
        // Add file count summary
        $structure .= "\n" . str_repeat('-', 50) . "\n";
        $structure .= "Total valid files analyzed: {$validFiles}\n";
    ...
    private function analyzeCodebase(): void
    {
        ...
        $codebase .= "\n" . str_repeat('=', 80) . "\n";
        $codebase .= "SUMMARY:\n";
        $codebase .= "Project: " . basename($this->rootPath) . "\n";
        $codebase .= "Total files processed: {$validFiles}\n";
        $codebase .= "Timestamp: " . date('Y-m-d H:i:s') . "\n";
        $codebase .= "Format: LLM-optimized for analysis and understanding\n";
        $codebase .= str_repeat('=', 80) . "\n";
    ...
    private function generateCodebase(): string
    {
        ...
        $codebase .= str_repeat('=', 80) . "\n";
        $codebase .= "PROJECT: " . basename($this->rootPath) . "\n";
        $codebase .= "TOTAL FILES: " . count($files) . "\n";
        $codebase .= "GENERATED: " . date('Y-m-d H:i:s') . "\n";
        $codebase .= str_repeat('=', 80) . "\n\n";
        ...
        foreach ($files as $file) {
            ...
            $codebase .= "SIZE: " . filesize($file) . " bytes\n";
            $codebase .= "TYPE: {$extension}\n";
            $codebase .= str_repeat('-', 80) . "\n";
