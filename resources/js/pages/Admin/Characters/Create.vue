            ...
            <form @submit.prevent="submitForm" class="w-full space-y-6 p-6">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div class="space-y-2">
                        ...
                        <Input id="fullname" type="text" autoFocus v-model="form.fullname" />
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <Input id="image" type="file" @input="onFileChange" accept="image/*" />
                        <img v-if="imagePreview" :src="imagePreview" alt="Image Preview" class="mt-2 max-h-40 w-auto" />
